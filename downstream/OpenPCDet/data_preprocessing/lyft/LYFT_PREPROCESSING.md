...
`downstream/OpenPCDet/data_preprocessing/lyft/meta_data/lyft_2019_train_sample_tokens.txt`.
...
The indices of traversals were dumped in `downstream/OpenPCDet/data_preprocessing/lyft/meta_data/lyft_2019_train_sample_tracks.pkl`.

## \[Optional\] Obtain the train/test split
**You can skip the following by directly using the uploaded files in
[`downstream/OpenPCDet/data_preprocessing/lyft/meta_data/`](./downstream/OpenPCDet/data_preprocessing/lyft/meta_data).** We include the corresponding
...
It will generate
```
downstream/OpenPCDet/data_preprocessing/lyft/meta_data/train_track_list.pkl
downstream/OpenPCDet/data_preprocessing/lyft/meta_data/valid_train_idx_info.pkl
downstream/OpenPCDet/data_preprocessing/lyft/meta_data/train_idx.txt # 12407 samples

downstream/OpenPCDet/data_preprocessing/lyft/meta_data/test_track_list.pkl
downstream/OpenPCDet/data_preprocessing/lyft/meta_data/valid_test_idx_info.pkl
downstream/OpenPCDet/data_preprocessing/lyft/meta_data/test_idx.txt # 2917 samples
```
**Note that the `test_idx.txt` is not used, please use `downstream/OpenPCDet/data_preprocessing/lyft/meta_data/time_valid_test_idx.txt`
...
We observe a similar trend on `downstream/OpenPCDet/data_preprocessing/lyft/meta_data/test_idx.txt`.
