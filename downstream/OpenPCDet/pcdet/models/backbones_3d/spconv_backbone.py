...
class VoxelBackBone8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        #     if self.model_cfg.P2_LOSS_CONFIG.FEATURE_TYPE == "squash":
        #         self.p2_backbone = nn.Sequential(
        #             nn.Linear(64, 32), nn.ReLU(), nn.Linear(32, 1)
        #         )
        #     elif self.model_cfg.P2_LOSS_CONFIG.FEATURE_TYPE == "point":
        #         self.p2_backbone = nn.Sequential(
        #             nn.Linear(128, 64),
        #             nn.ReLU(),
        #             nn.Linear(64, 32),
    ...
    def forward(self, batch_dict):
        ...
        # if self.model_cfg.get("P2_LOSS_CONFIG", None) is not None:
        #     _, _, p2_features = self.break_up_pc(batch_dict["points_voxels"])
        #     self.p2_scores = torch.tensor(batch_dict["p2_score"])
