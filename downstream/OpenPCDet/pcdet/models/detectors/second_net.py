...
class SECONDNet(Detector3DTemplate):
    ...
    def get_training_loss(self):
        ...
        if hasattr(self, 'history_query') and self.history_query is not None \
            ...
            loss = loss_rpn + loss_hist_query
        elif self.backbone_2d.model_cfg.get("P2_LOSS_CONFIG", None) is not None:
            loss_p2 = self.backbone_2d.get_loss()
            loss = loss_rpn + loss_p2
        else:
            loss = loss_rpn
